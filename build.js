...
function buildBundle() {
  console.log(`Building PharmTrace / MedCheck Engine bundle (${MINIFY ? 'minified' : 'development'})...`);

  const parts = [`// PharmTrace / MedCheck Engine bundle — built ${new Date().toISOString()}\n// DO NOT EDIT: auto-generated by build.js\n\n`];

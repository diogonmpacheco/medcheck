# MedCheck Public Trust Model

Generated: 2026-06-08

## Launch Status

MedCheck v1 is a source-linked educational preview. It is designed to make pharmacology, pharmacogenomics, metabolites, and interaction pathways easier to inspect. It is not a clinical decision system and it does not replace a licensed clinician or pharmacist.
